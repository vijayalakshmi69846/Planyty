...
const AccountTab = () => {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      await userService.changePassword(account.currentPassword, account.newPassword);
...
<Button
          ...
          disabled={loading.password || !account.currentPassword || !account.newPassword}
 ...
 <Button
          ...
          variant="secondary"
          className="border border-purple-300 text-purple-700 hover:bg-purple-50 disabled:opacity-50"
        >
