  ...
  const handleDemoLogin = (role) => {
    ...
    setTimeout(() => {
      ...
      login(demoEmail, demoPassword)
        .catch(err => {
             setFieldErrors({ password: 'Demo login failed.' });
             console.error(err);
        })
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#EED5F0] via-white to-[#A067A3] p-6">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl border border-gray-200 shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-all duration-500 animate-float">
        ...
        <div className="relative animate-fade-in delay-200">
          ...
          <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-gray-500">Plan with clarity ! Achieve with Planyty !</span></div>
        </div>
          ...
          <div className="animate-float delay-500">
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 pr-10 transition-all duration-300 ${fieldErrors.password ? 'border-red-500' : 'border-purple-200'}`}
              />
              <button
                type="button"
                ...
                tabIndex="-1" // Prevent tab-focus from interrupting typing flow
              >
